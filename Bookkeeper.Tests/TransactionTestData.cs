namespace Bookkeeper.Tests
{
    public static class TransactionTestData
    {
        ...
        public static string TwoValidTransactions => $"{ValidTransactionLineWithDebitAmount}{AbnAmroTabFileLineSplitter}{ValidTransactionLineWithDebitAmount}";

        public static string ValidTransactionsContainingGroceries => $"{ValidTransactionLineWithDebitAmount}{AbnAmroTabFileLineSplitter}{ValidTransactionLineWithDebitAmount}{AbnAmroTabFileLineSplitter}" +
